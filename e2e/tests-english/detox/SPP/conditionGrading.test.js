...
describe('SPP: Condition Grading Banner', () => {
    ...
    it.skip('Verify Excellend Condition Grade', async () => {
        ...
        assert.equal(await conditionsGradingBannerScreen.verifyConditionText(conditionGradingTranslation.ExcellentFirstPoint), conditionGradingTranslation.ExcellentFirstPoint.trim())
    ...
    it.skip('reload the app to close the banner then login', async () => {
