...
describe('Add new Category and verify listing process,explore screen', () => {
    ...
    let category, brand, model, variant, series, processor, processorEn, ram, ramEN, att1 = "Series", att2 = "Processor", att3 = "RAM", reason = "custom automation reason of selling"
    ...
    it('Adding new Category, brand,model,variant and setting up its data', async () => {
        ...
        series = "S Series", processor = "كور 2 ديو", ram = "ADATA 16GB 8*2"
        processorEn = "Core 2 Duo", ramEN = "ADATA 16GB 8*2"
    ...
    it('Verifying Device Type Screen - Variants', async () => {
        ...
        await DeviceTypeScreen.tapOnVariant(series)
    ...
    it('Verifying SPP Product Description', async () => {
        ...
        assert.equal(await SingleProductScreen.getTextModelValue(), model.nameEn)
    });
    it('Verifying SPP for a product Condition', async () => {
        ...
        assert.equal(await SingleProductScreen.getTextQuestionOfProductDetails(), yesNoQuestion.questionEn)
    ...
    it('Checking my products Screen, and clicking renew', async () => {
        ...
        assert.equal(await SoumProductCardScreen.getTxtProductName(), model.nameEn)
