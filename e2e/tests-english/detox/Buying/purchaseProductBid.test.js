...
//const tabbyPaymentScreenScreen = require("../../../../screens/Orders/tabbyPaymentScreen.screen");
describe('Bidding Tests: [Buying]: verify that user can Place a bid for a bid product, product have no other bidders', () => {
    ...
    it('Go to explore and filter by Laptops', async () => {
        ...
        await ExploreScreen.tapCategoryByName(exploreTranslation.laptops, false)
    ...
    it('Clicking bid now ', async () => {
        assert.equal(await SingleProductScreen.getTxtBidNow(), singleProductTranslation.bidNwButtonstart + `(${recommendedBidPrice}) ` + singleProductTranslation.riyal)
    ...
    it('Checking Checkout Screen: verifying payment methods and selecting tabby', async () => {
        ...
        await CheckoutScreen.tapOnPaymentMethodRadioBtnUnselected("Tabby")
    });
