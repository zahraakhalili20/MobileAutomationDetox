...
describe('Reserve a car with Apple pay and check failed payment', () => {
    ...
    it('Assert success order screen', async () => {
        ...
        assert.equal(await OrderSuccessScreen.getTxtPaymentStatus(),orderSuccessTranslation.paymentFailed)
        assert.equal(await OrderSuccessScreen.getTxtOrderQuote(),orderSuccessTranslation.yourCardWasDeclined)
