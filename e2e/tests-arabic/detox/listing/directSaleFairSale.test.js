...
describe('Direct Sale: verifying user can list a direct Sale product - Fair Sale', () => {
    let expectedSellPrice
    let expectedTimeTillSold
    let listingProduct = listingData.iphone15
    let sellPriceWithcommission, username
    ...
    it('Setting Up Test Data', async () => {
        ...
        expectedSellPrice = priceNudge.like_new
        expectedTimeTillSold = priceNudge.timeTillSold.timeTillSoldLightlyUsedFair
    ...
    it('Verifying  Device Status - Questions 1', async () => {
        ...
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q8)
        assert.equal(await DeviceStatusScreen.getTxtBtnYes(), listingData.mobilesQuestions.Q8_answers[0])
        assert.equal(await DeviceStatusScreen.getTxtBtnNo(), listingData.mobilesQuestions.Q8_answers[1])
    ...
    it('Verifying  Device Status - Questions 2', async () => {
        ...
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q9)
        assert.equal(await DeviceStatusScreen.getTxtBtnYes(), listingData.mobilesQuestions.Q9_answers[0])
        assert.equal(await DeviceStatusScreen.getTxtBtnNo(), listingData.mobilesQuestions.Q9_answers[1])
            await DeviceStatusScreen.tapBtnNo()
        await GeneralComponentsSellNowScreen.tapNextBtnEnabled()
    })
    it('Verifying  Device Status - Questions 3', async () => {
        ...
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q10)
        assert.equal(await DeviceStatusScreen.getTxtBtnYes(), listingData.mobilesQuestions.Q10_answers[0])
        assert.equal(await DeviceStatusScreen.getTxtBtnNo(), listingData.mobilesQuestions.Q10_answers[1])
    ...
    it('Verifying  Device Status - Questions 5', async () => {
        ...
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q2)
    ...
    it('Verifying  Device Status - Questions 6', async () => {
        ...
        assert.equal(await GeneralComponentsSellNowScreen.getTxtToAvoidReturnDisclaimer(), deviceStatusTranslation.disclaimer)
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q2)
        assert.equal(await DeviceStatusScreen.getTxtSubchoice(), listingData.mobilesQuestions.Q2_answers[5])
        assert.equal(await DeviceStatusScreen.getTxtSubchoice(1), listingData.mobilesQuestions.Q2_answers[4])
        assert.equal(await DeviceStatusScreen.getTxtSubchoice(2), listingData.mobilesQuestions.Q5_answers[0])
        assert.equal(await DeviceStatusScreen.getTxtSubchoice(3), listingData.mobilesQuestions.Q2_answers[6])
    ...
    it('Verifying  Device Status - Questions 8', async () => {
        ...
        assert.equal(await GeneralComponentsSellNowScreen.getTxtSteps(), deviceStatusTranslation.steps8)
        assert.equal(await GeneralComponentsSellNowScreen.getTxtToAvoidReturnDisclaimer(), deviceStatusTranslation.disclaimer)
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q2)

        await GeneralComponentsSellNowScreen.tapNextBtnEnabled()
    })
    it('Verifying  Device Status - Questions 9', async () => {
    ...
    it('Verifying  Device Status - Questions 10', async () => {

        assert.equal(await GeneralComponentsSellNowScreen.getTxtSteps(), deviceStatusTranslation.steps10)

        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q6)

        await GeneralComponentsSellNowScreen.tapNextBtnEnabled()
    })
    it('Verifying  Device Status - Questions 11', async () => {

        assert.equal(await GeneralComponentsSellNowScreen.getTxtSteps(7), deviceStatusTranslation.steps11)
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q4)
        /*** not working */
    ...
    it('Verifying  Device Status - Questions 12', async () => {

        assert.equal(await GeneralComponentsSellNowScreen.getTxtSteps(), deviceStatusTranslation.steps12)
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q3)
    ...
    it('Verifying  Device Status - Battery Health', async () => {
        ...
        // battery health
        assert.equal(await GeneralComponentsSellNowScreen.getTxtSteps(), deviceStatusTranslation.steps13)
        
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.mobilesQuestions.Q7)
    ...
    it('navigate back, click view All products Edit Product', async () => {
        ...
        assert.equal(await SoumProductCardScreen.getTxtProductName(), listingProduct.model)

        await MyProductsScreen.clickEditPrice()
        ...
        await DevicePriceEditScreen.clickSavePriceButton()
        await MyProductsScreen.waitForScreenShown()
        assert.equal(await SoumProductCardScreen.getTxtProductName(), listingProduct.model)
        assert.equal(await SoumProductCardScreen.getTxtCurrecny(), devicePriceDirectSaleTranslation.riyal)
