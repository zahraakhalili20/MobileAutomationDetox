...
describe('[Buying]: verify that user can buy a product of type direct sale product', () => {
    ...
    it('Verifying  Device Status - Questions 4', async () => {
        ...
        assert.equal(await DeviceStatusScreen.getTxtQuestion(), listingData.laptopsQuestions.Q2)
        assert.equal(await DeviceStatusScreen.getTxtSubchoice(), listingData.laptopsQuestions.Q2_answers[4])
        assert.equal(await DeviceStatusScreen.getTxtSubchoice(1), listingData.laptopsQuestions.Q5_answers[0])
        assert.equal(await DeviceStatusScreen.getTxtSubchoice(2), listingData.laptopsQuestions.Q5_answers[2])
        assert.equal(await DeviceStatusScreen.getTxtSubchoice(3), listingData.laptopsQuestions.Q5_answers[1])
    ...
    it('Verifying  Device Status - Questions 5', async () => {
        ...
        assert.equal(await GeneralComponentsSellNowScreen.getTxtSteps(), "5 " + deviceStatusTranslation.of + " 9")
        assert.equal(await GeneralComponentsSellNowScreen.getTxtToAvoidReturnDisclaimer(), deviceStatusTranslation.disclaimer)
    ...
    it('Verifying  Device Status - Questions 6', async () => {
        ...
        assert.equal(await GeneralComponentsSellNowScreen.getTxtSteps(), "7 " + deviceStatusTranslation.of + " 9")
        assert.equal(await GeneralComponentsSellNowScreen.getTxtToAvoidReturnDisclaimer(), deviceStatusTranslation.disclaimer)
    ...
    it('Verifying  Device Status - Questions 8', async () => {
        ...
        //are there warranty 
        assert.equal(await GeneralComponentsSellNowScreen.getTxtSteps(), "8 " + deviceStatusTranslation.of + " 9")
    ...
    it('Verifying  Device Status - Questions 8', async () => {
        ...
        // warranty expiration
        assert.equal(await GeneralComponentsSellNowScreen.getTxtSteps(), "9 " + deviceStatusTranslation.of + " 9")
    ...
    it('Filter by condition', async () => {
        ...
        await MPPScreen.tapOnFilterItemValue(mppTranslation.cleanUsed)
