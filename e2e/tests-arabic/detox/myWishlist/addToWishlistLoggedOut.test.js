...
describe('My Wishlist: Add Product to Wishlist while logged out ', () => {
    let testUser = usersData.user_1, productName, collectionName
    ...
    it('Randomly select any product and click Add to favorites', async () => {
        await homeScreen.clickOnFavorites(collectionName)
        await homeScreen.waitForFavoriteIcon()
        await homeScreen.clickOnProductImage(collectionName)
    })
